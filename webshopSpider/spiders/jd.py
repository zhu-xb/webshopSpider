# -*- coding: utf-8 -*-
import scrapy
from webshop.items import WebshopItem
import datetime
import re
import json
...
class JdSpider(scrapy.Spider):
    ...
    def __init__(self):
        ...
        self.productIds = ['412520','11863664','11863682','11881517','2202376',
                           ...
                           '1301236','1000840','1221514','1322298','2341748','772287','890975','418429','10032210','10113258','10212371']
        self.url_set = set()
    ...
    def parse(self, response):
        if response.status == 200:
            ...
            try:
                scripts = response.xpath('//body/script').extract()
                for temp in scripts:
                    if len(temp) >= 60 and re.match(r'^<script>[^<>]*var __proInformation[^<>]*</script>$', temp,re.I) != None:
                        PromotionJsons = json.loads(temp[36:-13])
                        for activityList in PromotionJsons['activityList']:
                            productPromotion = productPromotion + activityList['value'] + ';'
            except:
                pass
